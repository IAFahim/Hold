...
namespace _src.Scripts.StatsHelpers.StatsHelpers.Editor
{
    public abstract class EnumBuilderForStatsIntrinsic
    {
        ...
        private static StringBuilder GenerateCode(string enumName, string enumBaseType, List<SchemaInfo> collectedData, string sourceTypeName)
        {
            ...
            // CHANGE START: Add using statements to the top of the generated file
            sb.AppendLine("using System;");
            sb.AppendLine("using System.Runtime.CompilerServices;");
            sb.AppendLine("using Unity.Burst;");
            // Note: Make sure StatKey and IntrinsicKey are accessible.
            // This assumes they are in the BovineLabs.Stats namespace. Adjust if necessary.
            ...
            // CHANGE START: Conditionally add the Burst-compiled conversion methods for EStat
            if (enumName == "EStat")
            {
                sb.AppendLine();
                sb.AppendLine("    ");
            ...
            else
            {
                ...
                sb.AppendLine("    ");
                sb.AppendLine("    [MethodImpl(MethodImplOptions.AggressiveInlining)]");
                sb.AppendLine("    public static IntrinsicKey ToKey(this EIntrinsic intrinsic)");
                sb.AppendLine("    {");
