        ...
        if (characterBody.IsGrounded)
        {
            ...
            // Move on ground
            {
                ...
                CharacterControlUtilities.StandardGroundMove_Interpolated(ref characterBody.RelativeVelocity,
                    targetVelocity, chosenSharpness, deltaTime, characterBody.GroundingUp,
                    characterBody.GroundHit.Normal);
            }

            // Jumping
            if (characterControl.IsJumpPressed() ||
                (character.JumpPressedBeforeBecameGrounded &&
                 elapsedTime <
                 character.LastTimeJumpPressed +
                 character
                     .JumpBeforeGroundedGraceTime)) // this is for allowing jumps that were triggered shortly before becoming grounded
            {
