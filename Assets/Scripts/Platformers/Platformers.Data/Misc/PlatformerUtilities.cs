...
{
    public static void SetEntityHierarchyEnabled(bool enabled, Entity parent, EntityCommandBuffer commandBuffer,
        BufferLookup<LinkedEntityGroup> linkedEntityGroupFromEntity)
    {
        ...
        {
            var parentLinkedEntities = linkedEntityGroupFromEntity[parent];
            for (var i = 0; i < parentLinkedEntities.Length; i++)
                if (enabled)
    ...
    public static void SetEntityHierarchyEnabledParallel(bool enabled, Entity parent,
        EntityCommandBuffer.ParallelWriter ecb, int chunkIndex,
        BufferLookup<LinkedEntityGroup> linkedEntityGroupFromEntity)
    {
        if (enabled)
